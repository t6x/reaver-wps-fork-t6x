...
parse_modifiers(char * args[], /* Command line args */
    ...
    }        /* For as long as current arg matched and not out of args */ while ((i < count) && (k < modnum));
...
set_modulation_info(int skfd,
    ...
    if (!strcasecmp(args[0], "auto"))
        ...
        if (!strcasecmp(args[0], "fixed")) {
            ...
            }                /* For as long as current arg matched and not out of args */ while ((i < count) && (k < IW_SIZE_MODUL_LIST));
